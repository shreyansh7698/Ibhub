 ...
 * Dispatches to the real HTTP client. UI code imports from here only — never
 * from httpApi directly.
 */
...
export const listMyApplications = (...a) => impl.listMyApplications(...a);
...
export const getMyProfile = (...a) => impl.getMyProfile(...a);
