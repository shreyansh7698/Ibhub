...
export const DOC_TYPES = {
  ...
  aadhaar: {
    key: 'aadhaar',
    label: 'Aadhaar',
    description: 'A clear scan or photo of your Aadhaar card, front and back.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 8,
    previewable: false
  ...
  itr: {
    ...
    description: 'Your most recent Income Tax Return as proof of income.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 12,
    previewable: false
  ...
  travel_itinerary: {
    ...
    description: 'A day-by-day plan of your trip covering your intended dates of travel.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 8,
    previewable: true
  ...
  cover_letter: {
    key: 'cover_letter',
    label: 'Cover letter',
    description: 'A letter explaining the purpose of your trip and travel plans.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 8,
    previewable: true
  ...
  marriage_certificate: {
    ...
    description: 'Your marriage certificate, if applicable to your application.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 8,
    previewable: false
  ...
  employment_documents: {
    ...
    description: 'Proof of current employment, such as an employment letter or salary slips.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 12,
    previewable: false
  ...
  business_registration_documents: {
    key: 'business_registration_documents',
    label: 'Business registration documents',
    description: 'Registration proof for your business, if you are self-employed or a business owner.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 12,
    previewable: false
  ...
  sponsor_documents: {
    ...
    description: 'Identity and financial documents for your sponsor, if your trip is sponsored.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 12,
    previewable: false
  ...
  appointment_confirmation: {
    ...
    description: 'Your visa or biometric appointment confirmation, where one has been booked.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 8,
    previewable: true
  ...
  travel_history: {
    key: 'travel_history',
    label: 'Previous visa / travel history',
    description: 'Copies of previous visas or stamps showing your past international travel.',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptMimes: ['application/pdf', 'image/jpeg', 'image/png'],
    maxSizeMB: 12,
    previewable: true
