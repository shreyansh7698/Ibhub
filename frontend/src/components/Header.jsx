              ...
              <motion.div variants={{ hidden: { opacity: 0, x: 30 }, show: { opacity: 1, x: 0 } }}>
                {isUserAuthenticated() ? (
                  <div className="drawer__account">
                    <Link to="/profile" className="drawer__sublink" onClick={onClose}>
                      My Profile ({getUserSession()?.fullName || getUserSession()?.email})
                    </Link>
                    <button
                      type="button"
                      className="drawer__sublink drawer__signout"
                      onClick={() => {
                        userLogout();
                        onClose();
                      }}
                  ...
                  <Link to="/login" className="drawer__sublink" onClick={onClose}>
                    Login
                  </Link>
                )}
